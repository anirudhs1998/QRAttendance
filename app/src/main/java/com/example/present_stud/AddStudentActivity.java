...
public class AddStudentActivity extends AppCompatActivity {
    ...
    private EditText et_name,et_roll_no,et_dept,et_phone,et_email,et_password;
    ProgressDialog pd;
    Button b5;
    ...
    public void fnRegister(View view) {
        ...
        String arr[]=new String[]{name,rollno,dept,phone,email,password };
        for(int i=0;i<6;i++){
        ...
        try{
            final StudentInformation stdinfo=new StudentInformation("0",name,rollno,dept,phone,email,password,subject);
    ...
    public void saveInformation(StudentInformation stdinfo){
        ...
        try {
           ...
           stdinfo.setUid(id);
           databaseReference.child(id).setValue(stdinfo);
